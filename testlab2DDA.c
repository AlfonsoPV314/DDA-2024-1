...
int meta(int** tablero, int* dado, Pila* camino, int fila, int columna, int cantFilas, int cantCol, int posIni[2], int val){
    if (val){
        if(posIni[0]==fila){
            ...
            if (posIni[0]==fila+1 && esValido(1, tablero, fila, columna, cantFilas, cantCol, dado, camino, val)){
                return 3;
            }
            else if (posIni[0]==fila-1 && esValido(3, tablero, fila, columna, cantFilas, cantCol, dado, camino, val)){
                return 1;
            }
        }
    }
    ...
    while (i <= 5){
        ...
        if (i == 1){    //hacia arriba
            if (esValido(i, tablero, fila, columna, cantFilas, cantCol, dado, camino, val) == 1){
                ...
                moverDado(dado, i);
                realizarCamino(dado, fila-1, columna, tablero, posIni, camino, cantFilas, cantCol,1,exito);
            }
        }
            ...
            if (esValido(i, tablero, fila, columna, cantFilas, cantCol, dado, camino, val) == 1){
                ...
                moverDado(dado, i);
                realizarCamino(dado, fila, columna+1, tablero, posIni, camino, cantFilas, cantCol,1, exito);
            }
        }
